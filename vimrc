...
autocmd filetype ruby,haml,yaml,scss,sass,treetop set shiftwidth=2
autocmd filetype ruby,haml,yaml,scss,sass,treetop set tabstop=2
...
noremap <Leader>ff :FufBuffer**<cr>
